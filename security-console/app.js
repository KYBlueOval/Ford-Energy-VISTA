(()=>{
  ...
  function closeOperationModal(){const modal=$('#operationModal');modal.classList.add('hidden');$('#operationModalBody').innerHTML='';$('#operationModalFooter').innerHTML='';}
  ...
  function openRecord(r){
    ...
    $('#detailPanel').innerHTML=`
      ...
      <div class="actions">
        ...
        ${checkedIn&&permissions.checkOut?`<div class="action-section"><h3>Visitor Checkout</h3><div class="approval-banner allowed"><strong>Badge currently issued:</strong><span class="mono">${esc(r.badgeUid||'Unknown')}</span></div><button id="openCheckOutDialog">Return Badge & Check Out</button></div>`:''}
